...
<body id="Pagina">
	...
	<div id="Contenedor-Principal">
		...
		<main id="FormularioAñadir"> 
			...
			<form action="/operacionesBasicas" method="POST", files="true" enctype="multipart/form-data">
				@csrf
				
				<p>
					<label for="imagen">Imagen </label>
					<input type="file" name="fileRuta" id="imagen">
				</p>
				...
				<p>
					...
					<button type="submit" class="btn btn-primary" value="Añadir">Añadir</button>
				</p>
